...
d_luigi_run () {
    ...
    open -a web_search -g "localhost:$(d_luigi_port $1)"
...
export YC_SHAREPOINT_DIR="$HOME/Yellow Canary/Yellow Canary - Documents/"
export STAGING_DIR="$HOME/Pipeline_Output/"
